...
\begin{enumerate}
  \item Was bedeutet das spezielle Relativitätsprinzip für physikalische %1
    ...
    Die zwei Einstein'sche Postulate der spezielle Relativität lauten:

    1. Die physikalische Gesetze sind in alle 
    (gleichförmig geradlinig zueinander bewegte)
    Bezugssyteme gleich.

    2. Die Lichtgeschwindigkeit ist (im Vakuum) 
    eine Konstante ($c$) in jedem Bezugssystem
    und ist insbesondere unabhängig von der 
    Bewgegung der Quelle.
