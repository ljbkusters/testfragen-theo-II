...
\end{center}
\begin{enumerate}
  \item Wie lautet die Taylor-Entwicklung von $\rr{1}$ in den Komponenten %1
  ...
  \item Man drücke das elektrostatische Potential $\Phi(\vb* r)$ einer %2
  ...
  \item Man gebe Formel für das Monopolmoment, den Dipolvektor und den %3
        Quadrupoltensor an.
        \begin{center}
        \begin{tabular}{lll}
  ...
  \item Wie koppeln Monopol und Dipol an ein externes elektrostatisches %4
        Potential bzw. Feld?
  ...
  \clearpage
  \item Wie lautet die elektrostatische Energie einer Ladungsverteilung? %5
  ...
  \item Wie ist die elektrische Suszeptibilität $\chi$ in einem  %6
  ...
  \item Wie lautet der Zusammenhang zwischen elektrischem Feld,  %7
  ...
  \item Welche Feldgleichung erfüllt die dielektrische Verschiebung? %8
  ...
  \item Was geschieht mit dem $1/r$-Potential von Punktladungen in %9
        Metallen?
        \begin{center}
  ...
  \clearpage
  \textbf{[MAGNETOSTATIK]}
  \item Man schreibe die Kontinuitätsgleichung in differentieller Form %10
  ...
  \item Man schreibe Ladungsdichte $\rho(\vb* r)$ und Stromdichte %11
  ...
  \item Wie lautet das Biot-Savart'sche Gesetz für $\vb* A(\vb* r)$ und %12
        $\vb B(\vb* r)$?
  ...
  \item Wie lauten die zwei Feldgleichungen der Magnetostatik? %13
    \begin{equation*}
      \begin{array}{ll}
  ...
  \item Man berechne das magnetische Dipolmoment für eine Punktladung %14
    auf 
  ...
  \item Wie lauten die Zusammenhänge zwischen $\vb B$, $\vb H$  %15
